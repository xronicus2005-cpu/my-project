...
const Teach = () => {
  ...
  const handleCategoryClick = async (category) => {
    ...
    setError(null);
    try {
      const res = await api.get(`/getJobsTeach?profession=${category}`);
      ...
      <Container sx={{ mt: 5 }}>
        ...
        >
          ...
          >
            ...
            <Button sx={categoryBtnStyle(false)} onClick={() => handleCategoryClick("Online repititor")}>
              Online repititor
            </Button>
            <Button sx={categoryBtnStyle(false)} onClick={() => handleCategoryClick("Offline repititor")}>
              Offline repititor
            </Button>
          </Box>
