...
const Cars = () => {
  ...
  const handleCategoryClick = async (category) => {
    ...
    setError(null);
    try {
      const res = await api.get(`/getJobsCars?profession=${category}`);
      ...
      <Container sx={{ mt: 5 }}>
        ...
        >
          ...
          >
            ...
            <Button sx={categoryBtnStyle(false)} onClick={() => handleCategoryClick("Mexanik")}>
              Mexanik
            </Button>
            <Button sx={categoryBtnStyle(false)} onClick={() => handleCategoryClick("Kuzov ustasi")}>
              Kuzov ustası
            </Button>
          </Box>
