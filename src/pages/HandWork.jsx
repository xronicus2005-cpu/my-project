      ...
      <Container sx={{ mt: 3 }}>
        ...
        >
          ...
          >
            ...
            <Button onClick={() => handleCategoryClick("Qurilis")} sx={{ color: "#555" }}>
              Qurılıs
            </Button>
            <Button onClick={() => handleCategoryClick("Santexnika")} sx={{ color: "#555" }}>
              Santexnika
            </Button>
            <Button onClick={() => handleCategoryClick("Elektro montaj")} sx={{ color: "#555" }}>
              Elektro montaj
            </Button>
            <Button onClick={() => handleCategoryClick("Remont")} sx={{ color: "#555" }}>
              Remont
            </Button>
          </Box>
