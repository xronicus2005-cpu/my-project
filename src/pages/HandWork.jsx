...
const HandWork = () => {
  ...
  const handleCategoryClick = async (category) => {
    ...
    setError(null);
    try {
      const res = await api.get(`/getJobsHand?profession=${category}`);
      ...
      <Container sx={{ mt: 5 }}>
        ...
        >
          ...
          >
            ...
            <Button sx={categoryBtnStyle(false)} onClick={() => handleCategoryClick("Qurilis")}>
              Qurılıs
            </Button>
            <Button sx={categoryBtnStyle(false)} onClick={() => handleCategoryClick("Santexnika")}>
              Santexnika
            </Button>
            <Button sx={categoryBtnStyle(false)} onClick={() => handleCategoryClick("Elektro montaj")}>
              Elektro montaj
            </Button>
            <Button sx={categoryBtnStyle(false)} onClick={() => handleCategoryClick("Remont")}>
              Remont
            </Button>
          </Box>
